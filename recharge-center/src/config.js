...
export const config = {
  ...
  hSubscriptionSyncIntervalMs: Number(process.env.H_SUBSCRIPTION_SYNC_INTERVAL_MS || 15000),
  hSubscriptionSyncLookbackHours: Number(process.env.H_SUBSCRIPTION_SYNC_LOOKBACK_HOURS || 72),
